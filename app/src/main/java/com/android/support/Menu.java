...
public class Menu {
    ...
    public Menu(Context context) {
        ...
        // mExpanded.setPadding(2012, 2012, 2012, 1); //So borders would be visible
        ...
        gdMenuBody.setStroke(2012, Color.parseColor("#32cb00")); //Set border
    ...
    public void SetWindowManagerWindowService() {
        ...
        int iparams = Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O ? 1 : 2012;
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean bool) {
                ...
                switch (featNum) {
                    case -1: //Save perferences
                        Preferences.with(switchR.getContext()).writeBoolean(-2012, bool);
    ...
    private void Spinner(LinearLayout linLayout, final int featNum, final String featName, final String list) {
        ...
        spinner.getBackground().setColorFilter(2012, PorterDuff.Mode.SRC_ATOP); //trick to show white down arrow color
